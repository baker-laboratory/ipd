...
def test_basic_parse():
    test_selections = [
        ...
        "id 100+200+300", "all", "*", "none", "enabled", "first chain A", "last resn ALA", "model 1abc", "m. 1XYZ",
        "chain A", "c. B+C+D", "segi A", "s. PROA+PROB", "resn ALA+ARG+ASP", "r. GLY", "resi 10-20+100-120+200",
        "i. 1+2+3", "name CA", "n. N+CA+C+O", "alt A+B", "id 1+2+3", "rank 1+2+3", "pepseq AGTY", "ps. RGD",
        "label myLabel", "chain A in polymer.protein", "byobject chain A", "bysegi chain A", "bs. chain A",
        "bychain resi 100-200", "bc. name CA", "byres name CA", "br. resi 10-20", "bycalpha chain A", "bca. chain A",
        "bymolecule chain A", "bm. organic", "byfragment resn LIG", "bf. hetatm", "byring resn PHE", "bycell all",
        "bound_to resn ALA", "bto. name CA", "neighbor resn LIG", "nbr. name CA", "name CA extend 3.5",
        "chain A within 5 of chain B", "chain A w. 5 of chain B", "name CA around 3.5", "name CA a. 3.5",
        ...
        "chain A and not chain B or chain C", "chain A # this is a comment", "name CA # atoms only",
