...
def pymol_load_npndarray(
    ...
    **kw,
    ...
    if shape[-2:] in [(3, 4), (5, 4), (3, 3)]:
        ...
        return show_ndarray_point_or_vec(ipd.homog.hpoint(toshow), state=state, **kw)
    else:
...
def showme(*args, name=None, how="pymol", **kw):
    ...
    if how == "pymol":
        ...
        return NotImplementedError('showme how="%s" not implemented' % how)
