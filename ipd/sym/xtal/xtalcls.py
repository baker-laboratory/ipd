...
class Xtal:
    ...
    def cellframes(
        ...
        **kw,
        ...
        if xtalrad is not None:
            ...
            if center is None:
                center = asucen
            ipd.icv(center, asucen)  # type: ignore
    ...
    def asucen(
        ...
        **kw,
        ...
        if use_olig_nbrs:
            opcens = [np.mean(ipd.homog.hxform(e.operators[1:], cen0), axis=0)
                      for e in self.symelems]  # type: ignore
