...
import ipd
from ipd import ppp
from ipd.dev.apimeta import DBBase, Props, Attrs, props_default, attrs_default
...
class DBFileKind(DBBase, ppp.FileKindSpec, table=True):
    props: Props = props_default()
    attrs: Attrs = attrs_default()
...
client_model = ipd.dev.apimeta.make_client_models(ipd.ppp.spec_model, backend_model)
