...
Revision ID: 577c6bb9f84d
Revises: 
Create Date: 2024-10-12 23:15:11.247962
...
def upgrade() -> None:
    ...
    op.create_table('dbFileType', sa.Column('id', sa.Uuid(), nullable=False),
                    sa.Column('ispublic', sa.Boolean(), nullable=False),
                    sa.Column('telemetry', sa.Boolean(), nullable=False),
                    sa.Column('ghost', sa.Boolean(), nullable=False),
                    sa.Column('datecreated', sa.DateTime(), nullable=False),
    ...
    op.create_table('dbuseruserlink', sa.Column('followerid', sa.Uuid(), nullable=False),
    ...
    op.create_table('dbusergrouplink', sa.Column('userid', sa.Uuid(), nullable=False),
    ...
    op.create_table('dbpymolcmdflowsteplink', sa.Column('pymolcmdid', sa.Uuid(), nullable=False),
