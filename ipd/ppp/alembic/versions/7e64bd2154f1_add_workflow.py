...
Revision ID: 7e64bd2154f1
Revises: 
Create Date: 2024-10-07 19:39:31.834648
...
def upgrade() -> None:
    ...
    sa.Column('sym', sqlmodel.sql.sqltypes.AutoString(), nullable=False),
    sa.Column('ligand', sqlmodel.sql.sqltypes.AutoString(), nullable=False),
    sa.Column('workflowname', sqlmodel.sql.sqltypes.AutoString(), nullable=False),
    ...
    op.create_table('dbpymolcmdflowsteplink',
    sa.Column('pymolcmdid', sa.Integer(), nullable=False),
    sa.Column('flowstepid', sa.Integer(), nullable=False),
    sa.ForeignKeyConstraint(['flowstepid'], ['dbflowstep.id'], ),
    sa.ForeignKeyConstraint(['pymolcmdid'], ['dbpymolcmd.id'], ),
    sa.PrimaryKeyConstraint('pymolcmdid', 'flowstepid')
    )
    ...
    sa.Column('flowstepname', sqlmodel.sql.sqltypes.AutoString(), nullable=False),
    sa.Column('durationsec', sa.Integer(), nullable=False),
    sa.Column('filecontent', sqlmodel.sql.sqltypes.AutoString(), nullable=True),
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('props', sa.JSON(), nullable=True),
    sa.Column('attrs', sa.JSON(), nullable=True),
    sa.Column('fileid', sa.Integer(), nullable=False),
    sa.Column('pollid', sa.Integer(), nullable=False),
    sa.Column('workflowbbkey', sa.Integer(), nullable=False),
    sa.ForeignKeyConstraint(['fileid'], ['dbfile.id'], ),
    sa.ForeignKeyConstraint(['pollid'], ['dbpoll.id'], ),
    sa.ForeignKeyConstraint(['workflowbbkey'], ['dbworkflow.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
...
def downgrade() -> None:
    ...
    op.drop_table('dbpymolcmdflowsteplink')
